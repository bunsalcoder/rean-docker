(() => {
  ...
  const EN = {
    ...
    "home.pathEyebrow": "Milestones",
    "home.pathTitle": "Eight milestones on a twenty-chapter route",
    "home.pathLead":
      "These stops mark the path — volumes, networks, multi-stage, debugging, and security sit between them. Open Learn for every chapter.",
    "home.pathMore": "Browse all 20 chapters →",
    ...
    "home.meta.specialLab13": "Special · Lab 13",
    ...
    "progress.lead": "Checklist ticks stay on this device — export a backup when you switch machines.",
    ...
    "progress.exportDone": "Progress file downloaded.",
    "progress.importDone": "Progress restored on this device.",
    "progress.importFailed": "Could not import that file. Use a rean-docker progress export.",
    "search.title": "Search",
