(() => {
  ...
  const EN = {
    ...
    "home.pathTitle": "Twenty chapters. Nine labs. One clear route.",
    ...
    "labs.heading": "Labs",
    "labs.intro":
      "Work through these in order. Lab 01 is beginner isolation practice (not advanced theory). Lab 02 is the everyday Docker workflow. Each lab lives under labs/ — open a terminal next to this page.",
