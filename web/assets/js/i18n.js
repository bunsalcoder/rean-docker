(() => {
  ...
  const EN = {
    ...
    "home.pathTitle": "Twenty chapters. Ten labs. One clear route.",
    ...
    "home.meta.intermediateLab10": "Intermediate · Lab 10",
    "home.meta.intermediateLab04": "Intermediate · Lab 04",
    "home.meta.advancedLab08": "Advanced · Lab 08",
    "home.meta.specialLab09": "Special · Lab 09",
    ...
    "labs.heading": "Labs",
    "labs.intro":
      "Work through these in order. Lab 01 is beginner isolation practice (not advanced theory). Lab 02 is the everyday Docker workflow. Lab 10 (env/secrets) sits with Chapter 10 — do it after Lab 03, before Compose. Each lab lives under labs/ — open a terminal next to this page.",
    ...
    "labs.06.desc": "Keep database data after containers die.",
    "labs.07.title": "Multi-stage builds",
    "labs.07.desc": "Compare fat vs slim production images.",
    "labs.08.title": "Production practices",
    "labs.08.desc": "Healthchecks, limits, read-only rootfs.",
    "labs.09.title": "Deploy & CI/CD",
    "labs.09.desc": "Special: validate, smoke-test, tag, and ship with Compose + Actions.",
    ...
    "labMeta.10-env-secrets": "Env, secrets, and config",
    "labMeta.04-compose": "Compose stack",
    "labMeta.05-networks": "Networks & DNS",
    "labMeta.06-volumes": "Volumes & persistence",
    "labMeta.07-multi-stage": "Multi-stage builds",
    "labMeta.08-production": "Production practices",
    "labMeta.09-ci-cd": "Deploy & CI/CD",
  };
